...
static int extended_nonce_function( unsigned char *nonce32, const unsigned char *msg32,
        ...
        (*extra)++;
        return secp256k1_nonce_function_default( nonce32, msg32, key32, *extra, NULL );
}

const secp256k1_nonce_function_t bts_extended_nonce_function = extended_nonce_function;
