...
/** Create a secp256k1 context object with sign and verify flag.
 *  Returns: a newly created context object.
 */
secp256k1_context_t* secp256k1_context_create_sign_verify(
) SECP256K1_WARN_UNUSED_RESULT;

/** Create a secp256k1 context object with all flags.
 *  Returns: a newly created context object.
 */
secp256k1_context_t* secp256k1_context_create_all(
) SECP256K1_WARN_UNUSED_RESULT;
...
//bts extended nonce function
extern const secp256k1_nonce_function_t bts_extended_nonce_function;
